local library = loadstring(game:HttpGet(('https://raw.githubusercontent.com/Squex01/CoinCollectingSimulator/main/Coin%20Collecting%20Simulator.lua')))()
...
u:Button("Discrod Server",function()
    setclipboard("https://discord.gg/A9P8DVXW")
end)
